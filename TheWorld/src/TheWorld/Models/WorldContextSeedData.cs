...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            var findHagar = await _userManager.FindByEmailAsync("hagar@horrible.com");
            Console.WriteLine("Hagar = ", findHagar);
            if (findHagar == null)
            {
                var newUser = new WorldUser()
                {
                    UserName = "hagarthehorrible",
                    Email = "hagar@horrible.com"
                };
                Console.WriteLine("Attempting to create Hagar");
